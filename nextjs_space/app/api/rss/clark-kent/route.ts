      ...
      meta: {
        ...
        localFeedDiagnostics: {
          resolvedGeo: {
            ...
            resolvedGeoMethod: rssBrief?.diagnostics?.resolvedGeoMethod ?? 'none',
            countyCascadeResolutionMethod: rssBrief?.diagnostics?.countyCascadeResolutionMethod ?? 'not_reached',
          },
